...
export function SiteHeader() {
  return (
    <header className="border-b border-black/10 bg-[#f5f2ea]/85 backdrop-blur-xl sticky top-0 z-50">
      <div className="container-shell flex min-h-18 items-center justify-between gap-4 py-3">
        <Link href="/" className="flex items-center gap-3" aria-label="IBD — início">
          <span className="grid h-10 w-10 place-items-center rounded-full bg-[#20372f] text-sm font-black text-white">IBD</span>
          <span className="hidden sm:block">
            <strong className="block text-sm">Portal do Cliente</strong>
            <span className="text-xs muted">Processo claro. Próximo passo visível.</span>
          </span>
        </Link>
